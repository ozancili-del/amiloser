    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}html{scroll-behavior:smooth;}
        ...
        .modal-copy-btn{width:100%;font-family:'Bebas Neue',sans-serif;font-size:18px;letter-spacing:2px;padding:12px;border:none;border-radius:9px;cursor:pointer;}
